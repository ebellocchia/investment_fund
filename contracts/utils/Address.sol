...
library Address {
    ...
    /**
     * Return true if the specified account is a contract.
     *
     * NOTE:
     ...
     * @return bool True if the address is a contract, false otherwise (see note)
     */
    ...
    /**
     * Perform a Solidity function call using a low level call. A
    ...
    /**
     * Verify the result of a call and revert in case of failure.
     *
